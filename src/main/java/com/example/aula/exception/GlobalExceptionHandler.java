...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NumeroDaCamisaJaCadastrado.class)
    public ResponseEntity<Map<String, Object>> handlerNumeroDaCamisaJaCadastrado(NumeroDaCamisaJaCadastrado erro) {
        return ResponseEntity
